...
> Client 通过 OpenAI 兼容接口访问 FastAPI。路由层根据 `model` 字段从 Registry 选择 Chat/TTS 引擎。

<div align="center">

<svg width="920" height="220" viewBox="0 0 920 220" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Architecture diagram">
  <defs>
    <style>
      .box { fill:#0b1220; stroke:#334155; stroke-width:1.2; }
      .title { fill:#e5e7eb; font: 600 14px ui-sans-serif, system-ui, -apple-system, Segoe UI; }
      .text { fill:#cbd5e1; font: 12px ui-sans-serif, system-ui, -apple-system, Segoe UI; }
      .arrow { stroke:#94a3b8; stroke-width:1.6; marker-end:url(#m); }
      .tag { fill:#111827; stroke:#1f2937; stroke-width:1; }
      .tagt { fill:#e5e7eb; font: 600 12px ui-sans-serif, system-ui, -apple-system, Segoe UI; }
    </style>
  ...
  <!-- Client -->
  <rect x="30" y="80" width="170" height="70" rx="12" class="box" />
  <text x="115" y="110" text-anchor="middle" class="title">Client</text>
  <text x="115" y="132" text-anchor="middle" class="text">OpenAI SDK / curl</text>

  <!-- FastAPI -->
  <rect x="240" y="60" width="210" height="110" rx="12" class="box" />
  <text x="345" y="92" text-anchor="middle" class="title">FastAPI App</text>
  <text x="345" y="114" text-anchor="middle" class="text">/v1/* routes</text>
  <text x="345" y="136" text-anchor="middle" class="text">SSE / JSON / Audio bytes</text>

  <!-- Registry -->
  <rect x="500" y="60" width="190" height="110" rx="12" class="box" />
  <text x="595" y="92" text-anchor="middle" class="title">ModelRegistry</text>
  <text x="595" y="114" text-anchor="middle" class="text">chat_models</text>
  <text x="595" y="136" text-anchor="middle" class="text">tts_models</text>

  <!-- Engines -->
  <rect x="740" y="40" width="150" height="70" rx="12" class="box" />
  <text x="815" y="70" text-anchor="middle" class="title">Chat Engine</text>
  <text x="815" y="92" text-anchor="middle" class="text">MLX / Echo</text>

  <rect x="740" y="130" width="150" height="70" rx="12" class="box" />
  <text x="815" y="160" text-anchor="middle" class="title">TTS Engine</text>
  <text x="815" y="182" text-anchor="middle" class="text">macOS say</text>

  <!-- arrows -->
  <line x1="200" y1="115" x2="240" y2="115" class="arrow" />
  <line x1="450" y1="115" x2="500" y2="115" class="arrow" />
  <line x1="690" y1="95" x2="740" y2="75" class="arrow" />
  <line x1="690" y1="135" x2="740" y2="165" class="arrow" />

  <!-- tags -->
  <rect x="60" y="25" width="310" height="28" rx="10" class="tag" />
  <text x="215" y="44" text-anchor="middle" class="tagt">/v1/chat/completions · /v1/audio/speech · /v1/models</text>

  <rect x="410" y="185" width="280" height="24" rx="10" class="tag" />
  <text x="550" y="202" text-anchor="middle" class="tagt">按 model 选择引擎（chat vs audio）</text>
</svg>
